...
@export var PlayerInput: PlayerInputComponent

var movement_vector : Vector3

func apply_velocity(added_velocity: Vector3):
	Body.velocity += added_velocity
...
func accelerate() -> void:
	...
	accelspeed = Config.ACCELERATION * wishspeed * delta * PlayerInput.evade_accel_multiplier
